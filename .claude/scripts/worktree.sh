#!/usr/bin/env bash
# Manage per-topic git worktrees for ose-community.
#
...
# from under it. See AGENTS.md.
#
#   .claude/scripts/worktree.sh new <branch-name>   create .worktrees/<name> off fresh origin/main
